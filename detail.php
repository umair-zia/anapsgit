...
<div class="container-fluid" >
    <div class="container bg-dark text-white my-4 py-4 text-center">
        <h4 class="w-100 border-bottom mx-2 py-2"><?php echo $data['title']; ?></h4>
        <img src="<?php echo $data['path'];?>"  class="img-fluid">
        <p class="m-2 py-2"><?php echo $data['detail'];?></p>
